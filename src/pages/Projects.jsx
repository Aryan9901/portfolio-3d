			...
			<div className="flex justify-center md:justify-start items-center flex-wrap mt-16 mb-8">
				{["All", "React JS", "MERN", "Vanilla JS", "Mini Projects"]?.map((item, index) => (
					<div
						...
						className={`flex py-2 px-4 rounded-lg bg-white text-black font-extrabold cursor-pointer duration-300 transition-all ease-linear my-4 lg:my-2 mr-4 hover:bg-[#313bac] hover:text-white ${
							activeFilter === item ? "bg-[#313bac] text-white" : ""
						}`}
					>
						{item}
					</div>
