	...
	return (
		<section className="max-container">
			...
			<div className="mt-5 flex flex-col gap-3 text-slate-500">
				<p>
					I'm a MERN developer residing in Bhopal, India. I'm employed at Tryidol Technologies as a MERN developer and am also pursuing my
					studies. Continuously refining my skills through practical application, I've led numerous projects to fruition. Intrigued by the
					potential impact, I strive to make a difference through my work.
				</p>
			</div>
			...
			<div className="py-16" id="work">
				<h3 className="subhead-text">Work Experience & Acievements.</h3>
				<div className="mt-5 flex flex-col gap-3 text-slate-500">
